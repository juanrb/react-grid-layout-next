...
export type DroppingPosition = { left: number, top: number, e: React.DragEvent<HTMLDivElement> };
...
export function setTransform({ top, left, z, width, height }: Position): Object {
...
export function setTopLeft({ top, left, z, width, height }: Position): Object {
    return {
        top: `${top}px`,
        left: `${left}px`,
        width: `${width}px`,
...
export function synchronizeLayoutWithChildren(
    ...
    children && React.Children.forEach(Array.isArray(children) ? children : [children], (child: ReactElement<any>) => {
        // Child may not exist
...
export const noop: (args: any) => any = (_args: any) => { };
