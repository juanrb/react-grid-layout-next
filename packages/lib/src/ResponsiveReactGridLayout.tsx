...
export const ResponsiveReactGridLayout = (properties: Partial<ResponsiveProps>) => {
    ...
    const [prevProps, setPrevProps] = React.useState<{ width: number, breakpoints: Breakpoints<Breakpoint>, cols: Record<Breakpoint, number> }>({ width, breakpoints, cols })
