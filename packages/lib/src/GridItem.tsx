...
import { fastPositionEqual, GridDragStopEvent, perc, setTopLeft, setTransform } from "./utils";
import {
...
const GridItem = (props: Props & Partial<DefaultProps>) => {
     ...
     */
    const onDragStart: (Event, ReactDraggableCallbackData) => void = (e, { node }) => {
     ...
     * @param  {Object} callbackData  an object with node, delta and position information
     */
    const onDragStop: (Event, ReactDraggableCallbackData) => void = (e, { node }) => {
     ...
     */
    const onResizeStop: (e: Event, data: { node: HTMLElement, size: Position }) => void = (
        e,
        callbackData
    ) => {
     ...
     * @param  {Object} callbackData  an object with node and size information
     */
    const onResizeStart: (e: Event, data: { node: HTMLElement, size: Position }) => void = (
        e,
        callbackData
    ) => {
     ...
     * @param  {Object} callbackData  an object with node and size information
     */
    const onResize: (e: Event, data: { node: HTMLElement, size: Position }) => void = (
        e,
        callbackData
    ) => {
    ...
    const onResizeHandler = (
        ...
        (handler as GridItemCallback<GridResizeEvent>).call(this, { i, x: w, y: h, data: { e, node, size } });
    }
